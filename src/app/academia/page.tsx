  ...
  return (
    <div className="max-w-xl space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link href="/treinos" className="p-5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-violet-600 text-center transition-colors">
        ...
        <Link href="/dieta" className="p-5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-violet-600 text-center transition-colors">
