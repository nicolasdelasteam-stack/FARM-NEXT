...
export const DEFAULT_BOSSES: Boss[] = [
  ...
  { id: 'b_tita_suor', nome: 'Titã do Suor', icon: '🏃', lore: 'O Colosso Implacável — forjado de suor e cansaço, só recua diante de quem encara o próprio corpo sem piedade.', dificuldade: 'media', periodo: 'semanal', comoVencer: 'Complete o desafio físico proposto (ex: correr 10km ou equivalente) sem desistir no meio do caminho.', requisito: 'Desafio físico da semana concluído', penalidade: 'Perde acesso a recompensas de saúde/energia por 2 dias.', recompensa: 'Vale Buff de Energia', recompensaCoins: 50, recompensaXp: 120, recompensaEfeito: 'heal_full', condicao: 'Surge periodicamente pra testar sua resistência física.', derrotado: false, data: null },
  { id: 'b_ditador_tempo', nome: 'Ditador do Tempo', icon: '⏳', lore: 'Senhor das Rotinas Rígidas — um tirano que governa aqueles que seguem rotinas impecáveis. Ele testa sua consistência!', dificuldade: 'media', periodo: 'semanal', comoVencer: 'Criar uma nova rotina para os próximos 7 dias e segui-la sem falhas + finalizar 2 tarefas importantes antes do prazo.', requisito: 'Rotina de 7 dias sem falhas', penalidade: 'Perde um buff ativo.', recompensa: 'Poção do Dobro de XP', recompensaCoins: 100, recompensaXp: 150, recompensaEfeito: 'xp2x', condicao: 'Após completar 10 tarefas seguidas sem falhar.', derrotado: false, data: null },
