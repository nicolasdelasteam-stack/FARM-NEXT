...
export const SEASONAL_EVENTS: (EventoTemplate & { key: string; inicio: [number, number]; fim: [number, number] })[] = [
  ...
  { key: 'halloween', nome: 'Noite das Abóboras', icon: '🎃', descricao: '👻 Os bosses estão mais fortes... e as recompensas também: 1.5x XP e um doce misterioso no fim.', inicio: [10, 24], fim: [10, 31], dur: 8, recompensa: 'Vale Abóbora Secreta', efeito: 'abobora', coins: 66, mod: { xpMult: 1.5 } },
];
